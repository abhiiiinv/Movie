...
model_filename = "trained_movie_model3.sav"
...
feature_columns = [col for col in data.columns if col not in ["Unnamed: 0", "success", "profit", "revenue",'original_language']]
...
if st.button("Predict"):
    input_data = pd.DataFrame(
        [[adult, budget, popularity, runtime, video, vote_average, vote_count]],
